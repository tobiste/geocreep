...
Now we add some uncertainties to our temperature and pressure estimates, and then recaclulate the fugacity:
...
```{r plot2, fig.height=6, message=FALSE, warning=FALSE}
